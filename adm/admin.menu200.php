...
$menu['menu200'] = array(
    ...
    array('200300', '회원관리', G5_ADMIN_URL . '/member_list.php', 'mb_list'),
    //array('200300', '회원메일발송', G5_ADMIN_URL . '/mail_list.php', 'mb_mail'),
    // array('200800', '접속자집계', G5_ADMIN_URL . '/visit_list.php', 'mb_visit', 1),
    array('200800', '미디어 기사 관리', G5_ADMIN_URL . '/writing_list.php', 'mb_visit', 1),
    array('200810', '가입 미디어 관리', G5_ADMIN_URL . '/visit_search.php', 'mb_search', 1),
    array('200820', '기사 관리', G5_ADMIN_URL . '/article_create.php', 'mb_delete', 1),
