        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th scope="row"><label for="mb_password_confirm">비밀번호 확인<?php echo $sound_only ?></label></th>
                    <td>
                        <div>
                            <input type="password" name="mb_password_confirm" id="mb_password_confirm" <?php echo $required_mb_password ?> class="frm_input <?php echo $required_mb_password ?>" size="15" maxlength="20">
                        </div>
                        <div id="mb_password_captcha_wrap" style="display:none">
                            <!-- <?php
                            require_once G5_CAPTCHA_PATH . '/captcha.lib.php';
